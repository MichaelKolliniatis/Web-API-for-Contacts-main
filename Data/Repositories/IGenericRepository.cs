...
namespace Web_API_for_Contacts_2._0.Data.Repositories
{
    public interface IGenericRepository<T> where T : class
    {
        ...
        Task<List<TOut>> SelectWhereAsync<TOut>(Expression<Func<T, bool>> predicate, Expression<Func<T, TOut>> selector, bool asNoTracking = true, CancellationToken ct = default);
